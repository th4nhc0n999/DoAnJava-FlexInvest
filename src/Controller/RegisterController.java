...
public class RegisterController {
    ...
    public String registerController(String username, String email,
        ...
        if (accountDAO.getByUsername(username) != null) return "USERNAME_EXISTS";
        if (userDAO.getUserByEmail(email) != null)      return "EMAIL_EXISTS";
